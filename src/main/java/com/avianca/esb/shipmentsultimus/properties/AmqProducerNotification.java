...
@Configuration
@PropertySource("file:///${CONFIG_LOCATION}/amq_prod_notification.properties")
@ConfigurationProperties(prefix = "amq.notify.prod")
public class AmqProducerNotification {
